  ...
  return (
    <div className="bg-[#FEFFC0]">
      <div className="m-4">
        ...
        <div className="bg-[#EEF3FF] p-6 rounded-lg shadow-md flex justify-center flex-col border-t border-l border-black border-r border-b" style={{borderRight: '8px solid #F8AA26', borderBottom: '8px solid #F8AA26'}}>
        ...
        <p><span className="font-bold">NAME:</span> {petData.name}</p>
        <p><span className="font-bold">AGE:</span> {petData.age} Years</p>
        <p><span className="font-bold">TYPE:</span> {petData.type}</p>
        <p><span className="font-bold">GENDER:</span> {petData.gender}</p>
        <p><span className="font-bold">FROM:</span> 15-01-2000</p>
        <p><span className="font-bold">TO:</span> 25-01-2000</p>
        ...
        <div className="flex justify-center">
          <button type="submit" className="p-2 bg-[#0B0019] text-white rounded-3xl hover:opacity-80 focus:outline-none focus:ring focus:border-blue-300 w-36">Adopt Now</button>
        </div>
        </div>
        <div className="bg-[#EEF3FF] mt-5 p-6 rounded-lg shadow-md border border-black">
            <h1 className="text-center text-2xl lg:text-4xl font-bold mb-4">PHOTO GALLERY</h1>
        ...
        <p className="text-2xl text-center bg-[#0B0019] text-[#EEF3FF]">BREED: <span className="font-bold text-[#EAA124]">{petData.breed}</span> </p>
      </div>
    </div>
  );
}
